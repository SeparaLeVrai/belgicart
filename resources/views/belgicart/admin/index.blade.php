        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white mt-5 overflow-hidden shadow-xl sm:rounded-lg">
                                        ...
                                        <td class="border px-4 py-2 space-x-4">
                                            ...
                                            @if ($user->niveau_id === 2)
                                                <a href="{{ route('users.destroy', $user->id) }}"
                                                    onclick="event.preventDefault(); document.getElementById('delete-user-form-{{ $user->id }}').submit();">Supprimer</a>
                                            @endif
                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="" class="flex flex-col space-y-4 text-gray-500">
                        ...
                        {{-- <!-- Bonne réponse -->
                        <div>
                            <x-input-label for="rep1" :value="__('Bonne réponse')" />
                            <x-text-input id="rep1" class="block mt-1 w-full" type="text" name="rep1"
                                :value="old('rep1')" autofocus />
                            <x-input-error :messages="$errors->get('rep1')" class="mt-2" />
                        </div>

                        <!-- Mauvaise réponse -->
                        <div>
                            <x-input-label for="rep2" :value="__('Mauvaise réponse')" />
                            <x-text-input id="rep2" class="block mt-1 w-full" type="text" name="rep2"
                                :value="old('rep2')" autofocus />
                            <x-input-error :messages="$errors->get('rep2')" class="mt-2" />
                        </div> --}}
